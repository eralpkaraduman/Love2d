-- Based on: https://raw.githubusercontent.com/SkyVault/Love2DTutorialSeries/master/Tiled/tiledmap.lua
  ...
  for y = 0, (tileset.imageheight / tileset.tileheight) - 1 do
    for x = 0, (tileset.imagewidth / tileset.tilewidth) - 1 do
      local quad = love.graphics.newQuad(
                     ...
                     tileset.tilewidth, tileset.tileheight, tileset.imagewidth,
                     tileset.imageheight
                   )
